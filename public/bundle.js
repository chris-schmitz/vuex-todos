...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/ToDos/ToDos.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/cschmitz/Development/CS/WebCode/Demos/Vue/Not Part of Meetup presentation/vuex-todo/src/ToDos/ToDos.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ToDos.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ToDos.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "div.task-list {\n  border: 1px solid green;\n  margin-bottom: 1px;\n  padding: 20px; }\n  div.task-list span {\n    color: red; }\n  div.task-list .complete {\n    color: grey;\n    text-decoration: line-through; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddsTask = __webpack_require__(11);

	var _AddsTask2 = _interopRequireDefault(_AddsTask);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = {
	    components: {
	        addsTask: _AddsTask2.default
	    },
	    computed: {
	        tasks: function tasks() {
	            return _store2.default.state.tasks;
	        }
	    },
	    methods: {
	        toggleComplete: function toggleComplete(task) {
	            _store2.default.dispatch('TOGGLECOMPLETE', task);
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/ToDos/AddsTask.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/cschmitz/Development/CS/WebCode/Demos/Vue/Not Part of Meetup presentation/vuex-todo/src/ToDos/AddsTask.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./AddsTask.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./AddsTask.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	module.exports = {
	    ...
	    methods: {
	        addTask: function addTask(newTask) {
	            _store2.default.dispatch('ADDTASK', this.newTask);
	            this.newTask = '';
	        }
	    }
	};
...
/***/ function(module, exports) {
	...
	module.exports = "\n    <div class=\"task-list\" v-for=\"task in tasks\">\n        <span @click=\"toggleComplete(task)\" :class=\"{'complete': task.complete}\">{{ task.description }}</span>\n    </div>\n    <adds-task></add-stask>\n</template>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var state = {
	    tasks: [{ description: 'feed the dogs', complete: false }, { description: 'walk with the baby', complete: false }]
	};

	var mutations = {
	    TOGGLECOMPLETE: function TOGGLECOMPLETE(state, task) {
	        task.complete = !task.complete;
	    },
	    ADDTASK: function ADDTASK(state, task) {
	        var newTask = { description: task, complete: false };
